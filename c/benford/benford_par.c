 ...
 * Method of counting: Global Counter Array Protected by Single Mutex
 * 
...
void* count_digits(void* arg) {
    // cast args to threadargs struct
    ThreadArgs* args = (ThreadArgs*)arg;
    
    // Process assigned portion of data array
    for(int i = args->start; i < args->end; i++) {
        int digit = leadingDigit(data[i]);
        
        // Lock the single mutex, update count, then unlock
